...
# INSTRUCTIONS:
#
# This script sets up aditional prerequisites for Oppia
# It's better if you copy this file somewhere outside this project, e.g.
#     cp scripts/oppia_setup.sh ~/opensource
# Run the script from wherever with:
#     bash oppia_setup.sh
